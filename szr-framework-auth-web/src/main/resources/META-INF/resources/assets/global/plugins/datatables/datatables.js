 ...
 *   https://datatables.net/download/#bs/dt-1.10.13/af-2.1.3/b-1.2.4/b-colvis-1.2.4/cr-1.3.2/fc-3.2.2/fh-3.1.2/r-2.1.1/rr-1.2.0/sc-1.4.2/se-1.2.0
 *
 * Included libraries:
 *   DataTables 1.10.13, AutoFill 2.1.3, Buttons 1.2.4, Column visibility 1.2.4, ColReorder 1.3.2, FixedColumns 3.2.2, FixedHeader 3.1.2, Responsive 2.1.1, RowReorder 1.2.0, Scroller 1.4.2, Select 1.2.0
 */
...
(function( $, window, document, undefined ) {
	...
	function _fnAjaxParameters( settings )
	{
		...
		var d = {
			...
			//为适用spring标准分页接口而改造byWangChen20170322
			page:  (displayStart/displayLength) + 1,//当前页码
			size:  displayLength,//每页大小
			search:  {
	...
	function _fnAjaxUpdateDraw ( settings, json )
	{
		...
		//为适用spring标准分页接口而改造byWangChen20170322
		var tmpRecordsTotal    = compat( 'iTotalRecords',        'recordsTotal' );
		var recordsTotal = (tmpRecordsTotal == undefined ? 
								(json['data'] == undefined ? null :
									json['data']['totalElements'] != undefined ?
									json['data']['totalElements'] :
									json['data']) :
								tmpRecordsTotal
							);
		var tmpRecordsFiltered = compat( 'iTotalDisplayRecords', 'recordsFiltered' );
		var recordsFiltered = (tmpRecordsFiltered == undefined ? 
									(json['data'] == undefined ? null :
										json['data']['totalElements'] != undefined ?
										json['data']['totalElements'] : 
										json['data']) :
	...
	function _fnAjaxDataSrc ( oSettings, json )
	{
		...
		if ( dataSrc === 'data' ) {
			...
			var dataParam = json[dataSrc] != undefined ? 
					(json[dataSrc]['content'] != undefined ? 
							json[dataSrc]['content'] : 
							json[dataSrc]): 
					[];
			return json.aaData || dataParam;//为适用spring标准分页接口而改造byWangChen20170322
		}
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/dt-1.10.13/af-2.1.3/b-1.2.4/b-colvis-1.2.4/cr-1.3.2/fc-3.2.2/fh-3.1.2/r-2.1.1/rr-1.2.0/sc-1.4.2/se-1.2.0",
